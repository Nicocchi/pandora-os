...
void _cdecl printf(const char *fmt, ...)
{
  ...
  argp++; // inc by the size of "format" divided by sizeof(int) so it works with far pointers
  while (*fmt)
  {
    switch(state)
    {
...
const char g_HexChars[] = "0123456789abcdef"; // Contain the list of hexadecimal characters, which should also cover the decimal and octal
